...
$GLOBALS['_CRM_CONTACT_BAO_QUERY']['skipFields'] =  array( 'postal_code', 'group', 'tag' );
...
class CRM_Contact_BAO_Query {
    ...
    function CRM_Contact_BAO_Query( $params = null, $returnProperties = null, $fields = null,
                          $includeContactIds = false, $strict = true, $mode = 1 ) {
    ...
    function initialize( ) {
        ...
        $this->_fromClause  = CRM_Contact_BAO_Query::fromClause( $this->_tables, null, null, $this->_primaryLocation ); 
    }
     ...
     * @static
     */
     function getWhereClause( $params, $fields, &$tables, $strict = false ) {
     ...
     * @static
     */
     function fromClause( &$tables , $inner = null, $right = null, $primaryLocation = true ) {
    ...
    function searchQuery( $offset = 0, $rowCount = 0, $sort = null, 
        ...
        $permission = ' ( 1 ) ';
        if ( $this->_search ) {
            $permission = CRM_Core_Permission::whereClause( CRM_CORE_PERMISSION_VIEW, $this->_tables );
