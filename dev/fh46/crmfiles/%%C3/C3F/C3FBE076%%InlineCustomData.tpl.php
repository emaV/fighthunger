...
smarty_core_load_plugins(array('plugins' => array(array('block', 'ts', 'CRM/Contact/Page/View/InlineCustomData.tpl', 14, false),array('modifier', 'cat', 'CRM/Contact/Page/View/InlineCustomData.tpl', 23, false),)), $this); ?>
...
unset($_smarty_tpl_vars);
 ...
 echo '';  if ($this->_tpl_vars['cd_value']['options_per_line'] != 0):  echo '';  $this->assign('element_name', ((is_array($_tmp='custom_')) ? $this->_run_mod_handler('cat', true, $_tmp, $this->_tpl_vars['field_id']) : smarty_modifier_cat($_tmp, $this->_tpl_vars['field_id'])));  echo '<dt>';  echo $this->_tpl_vars['cd_value']['label'];  echo ' </dt><dd>';  if ($this->_tpl_vars['viewForm'][$this->_tpl_vars['element_name']]):  echo '';  $this->assign('count', '1');  echo '';  $this->assign('no', '1');  echo '';  echo '<table class="form-layout-compressed"><tr>';  unset($this->_sections['rowLoop']);
...
$this->_sections['rowLoop']['last']       = ($this->_sections['rowLoop']['iteration'] == $this->_sections['rowLoop']['total']);
 echo '';  $this->assign('index', $this->_sections['rowLoop']['index']);  echo '';  if ($this->_tpl_vars['viewForm'][$this->_tpl_vars['element_name']][$this->_tpl_vars['index']]['html'] != ""):  echo '';  if ($this->_tpl_vars['no'] != '1'):  echo ', ';  endif;  echo '';  echo $this->_tpl_vars['viewForm'][$this->_tpl_vars['element_name']][$this->_tpl_vars['index']]['html'];  echo '';  $this->assign('no', ($this->_tpl_vars['no']+1));  echo '';  if ($this->_tpl_vars['count'] == $this->_tpl_vars['cd_value']['options_per_line']):  echo '</tr><tr>';  $this->assign('count', '1');  echo '';  else:  echo '';  $this->assign('count', ($this->_tpl_vars['count']+1));  echo '';  endif;  echo '';  endif;  echo '';  endfor; endif;  echo '</tr></table>';  echo '';  else:  echo '&nbsp;';  endif;  echo '</dd>';  else:  echo '';  $this->assign('name', ($this->_tpl_vars['cd_value']['name']));  echo '';  $this->assign('element_name', ((is_array($_tmp='custom_')) ? $this->_run_mod_handler('cat', true, $_tmp, $this->_tpl_vars['field_id']) : smarty_modifier_cat($_tmp, $this->_tpl_vars['field_id'])));  echo '<dt>';  echo $this->_tpl_vars['cd_value']['label'];  echo '</dt><dd>';  echo $this->_tpl_vars['viewForm'][$this->_tpl_vars['element_name']]['html'];  echo '&nbsp;</dd>';  endif;  echo '';  endforeach; endif; unset($_from);  echo '</dl></fieldset></div>';  endforeach; endif; unset($_from);  echo '</div>';  endif;  echo '';  endif;  echo ''; ?>
