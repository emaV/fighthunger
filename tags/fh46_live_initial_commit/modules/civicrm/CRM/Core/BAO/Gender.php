...
class CRM_Core_BAO_Gender extends CRM_Core_DAO_Gender {
     ...
     */
     function &getDefault() {
        if ($GLOBALS['_CRM_CORE_BAO_GENDER']['_defaultIndividualSuffix'] == null) {
            $defaults = array();
            $GLOBALS['_CRM_CORE_BAO_GENDER']['_defaultIndividualSuffix'] = CRM_Core_BAO_Gender::retrieve($params, $defaults);
        }
        return $GLOBALS['_CRM_CORE_BAO_GENDER']['_defaultIndividualSuffix'];
    }
