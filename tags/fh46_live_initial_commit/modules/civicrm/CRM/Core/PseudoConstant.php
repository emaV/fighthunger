...
class CRM_Core_PseudoConstant {
     ...
     *
     */
      function &activityType( $all = false, $cond = 'id > 3' )
    {
    ...
    */
      ...
      function &allSavedSearch()
    {
        if (!$GLOBALS['_CRM_CORE_PSEUDOCONSTANT']['savedSearch']) {
            CRM_Core_PseudoConstant::populate( $GLOBALS['_CRM_CORE_PSEUDOCONSTANT']['savedSearch'], 'CRM_Contact_DAO_SavedSearch', true, 'title' );
        }
