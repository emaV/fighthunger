<?php /* Smarty version 2.6.12-dev, created on 2006-07-10 08:03:45
         compiled from CRM/Contact/Page/View/Basic.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('block', 'ts', 'CRM/Contact/Page/View/Basic.tpl', 8, false),array('function', 'crmURL', 'CRM/Contact/Page/View/Basic.tpl', 11, false),array('function', 'cycle', 'CRM/Contact/Page/View/Basic.tpl', 195, false),array('modifier', 'nl2br', 'CRM/Contact/Page/View/Basic.tpl', 75, false),array('modifier', 'crmDate', 'CRM/Contact/Page/View/Basic.tpl', 124, false),array('modifier', 'crmMoney', 'CRM/Contact/Page/View/Basic.tpl', 137, false),array('modifier', 'mb_truncate', 'CRM/Contact/Page/View/Basic.tpl', 199, false),array('modifier', 'count_characters', 'CRM/Contact/Page/View/Basic.tpl', 412, false),)), $this); ?>
...
?>
   ...
   <div class="col2">
    <?php if ($this->_tpl_vars['config']->mapAPIKey && $this->_tpl_vars['loc']['is_primary'] && $this->_tpl_vars['loc']['address']['geo_code_1'] && $this->_tpl_vars['loc']['address']['geo_code_2']): ?>
        <a href="<?php echo CRM_Utils_System::crmURL(array('p' => 'civicrm/contact/search/map','q' => "reset=1&cid=".($this->_tpl_vars['contactId'])), $this);?>
...
?>
 ...
 &nbsp; <?php endif; ?>
  ...
  <div class="col2">
    <label><?php $this->_tag_stack[] = array('ts', array()); smarty_block_ts($this->_tag_stack[count($this->_tag_stack)-1][1], null, $this, $_block_repeat=true);while ($_block_repeat) { ob_start(); ?>Prefers:<?php $_block_content = ob_get_contents(); ob_end_clean(); echo smarty_block_ts($this->_tag_stack[count($this->_tag_stack)-1][1], $_block_content, $this, $_block_repeat=false); }  array_pop($this->_tag_stack); ?></label> <?php echo $this->_tpl_vars['preferred_communication_method_display']; ?>
