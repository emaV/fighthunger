<?php /* Smarty version 2.6.12-dev, created on 2006-04-27 09:53:34
         compiled from CRM/UF/Form/Group.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('block', 'ts', 'CRM/UF/Form/Group.tpl', 4, false),array('modifier', 'crmReplace', 'CRM/UF/Form/Group.tpl', 35, false),array('function', 'crmURL', 'CRM/UF/Form/Group.tpl', 59, false),)), $this); ?>
...
&nbsp;<?php endif;  echo $this->_tpl_vars['otherModuleString']; ?>
        ...
        <tr><td><?php $this->_tag_stack[] = array('ts', array()); smarty_block_ts($this->_tag_stack[count($this->_tag_stack)-1][1], null, $this, $_block_repeat=true);while ($_block_repeat) { ob_start(); ?>Profiles can be explicitly linked to a module page. Any Profile form/listings page can also be linked directly by adding it's ID to the civicrm/profile path. (Example: <em><?php echo $this->_tpl_vars['siteRoot']; ?>
/civicrm/profile?reset=1&id=3</em>)<?php $_block_content = ob_get_contents(); ob_end_clean(); echo smarty_block_ts($this->_tag_stack[count($this->_tag_stack)-1][1], $_block_content, $this, $_block_repeat=false); }  array_pop($this->_tag_stack); ?>
